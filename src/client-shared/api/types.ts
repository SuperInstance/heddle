...
export type ControlPlaneSlashCommandCatalog = RouterOutputs['controlPlane']['slashCommandCatalog'];
export type ControlPlaneSlashCommandHint = ControlPlaneSlashCommandCatalog['hints'][number];
export type ControlPlaneSlashCommandResult = RouterOutputs['controlPlane']['slashCommandExecute'];
